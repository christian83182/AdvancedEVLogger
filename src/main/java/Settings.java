...
public class Settings {
    ...
    static Color ALL_CHARGERS_FILL = new Color(ALL_CHARGERS_COLOUR.getRed(),ALL_CHARGERS_COLOUR.getGreen(),ALL_CHARGERS_COLOUR.getBlue(),50);
    static Color SINGLE_CHARGER_FILL = new Color(SINGLE_CHARGER_COLOUR.getRed(),SINGLE_CHARGER_COLOUR.getGreen(),SINGLE_CHARGER_COLOUR.getBlue(),50);
    static Color MOVING_AVERAGE_FILL = new Color(MOVING_AVERAGE_COLOUR.getRed(),MOVING_AVERAGE_COLOUR.getGreen(),MOVING_AVERAGE_COLOUR.getBlue(),50);
    static Color GENERATED_FILL = new Color(GENERATED_LINE_COLOUR.getRed(),GENERATED_LINE_COLOUR.getGreen(),GENERATED_LINE_COLOUR.getBlue(),50);
    static Color GENERATED_HIGHLIGHT_COLOUR = new Color(GENERATED_LINE_COLOUR.getRed(),GENERATED_LINE_COLOUR.getGreen(),GENERATED_LINE_COLOUR.getBlue(),35);
